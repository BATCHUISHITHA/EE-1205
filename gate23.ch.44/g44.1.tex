...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.25]{../gate23.ch.44/figs/g44fig2.jpeg}
    \caption{ }
    \label{}
\end{figure}
...
\begin{equation}
\sbrak{\brak{y_{sp}-y(s)}(1) -a}10+ d_2(s)\frac{1}{0.1s+1} =a \\ \label{eq:ishitha.g23.ch44.1.eq}
\end{equation}

\begin{equation}
a\brak{\frac{1}{s+1}} + d_1(s)\frac{1}{(2s+1)} =y(s) \\  \label{eq:ishitha.g23.ch44.2.eq}
\end{equation}

From~\eqref{eq:ishitha.g23.ch44.1.eq}
\begin{align}
\brak{y_{sp}-y(s)}10 -10a + d_2(s)\frac{1}{0.1s+1}&=a \\
\brak{y_{sp}-y(s)}10 + \frac{d_2(s)}{0.1s+1} =11a 
\end{align}

\begin{equation}
\brak{y_{sp}-y(s)}\frac{10}{11} + \frac{d_2(s)}{11\brak{0.1s+1}} = a \\ \label{eq:ishitha.g23.ch44.3.eq}
\end{equation}
...
\brak{y_{sp}-y(s)}\frac{10}{11}\frac{1}{\brak{s+1}} + \frac{d_2(s)}{11\brak{0.1s+1}\brak{s+1}} +  d_1(s)\frac{1}{(2s+1)} &= y(s) 
\end{align} 

\begin{align}
\brak{0-y(s)}\frac{10}{11}\frac{1}{\brak{s+1}} + \frac{d_2(s)}{11\brak{0.1s+1}\brak{s+1}} &= y(s) \\
\frac{d_2(s)}{11\brak{0.1s+1}\brak{s+1}} &= y(s) + \frac{10}{11}y(s)\frac{1}{\brak{s+1}} \\
