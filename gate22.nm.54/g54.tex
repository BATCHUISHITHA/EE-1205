...
X_2(s)\brak{s^4 - s^3 x_2(0) - s^2 \dot{x_2}(0) -s\ddot{x_2}(0)-\dddot{x_2}(0)} &+\nonumber \\ 4X_2(s)\brak{s^2-sx_2(0)-\dot{x_2}(0)} + 2X_2(s) =0
\end{align}

\begin{align}
X_2(s)\brak{s^4 - s^3 x_2(0) - s^2 \dot{x_2}(0)} &+\nonumber \\ 4X_2(s)\brak{s^2-sx_2(0)} + 2X_2(s) =0\\
X_2(s)\brak{s^4 -\brak{s^3+4s}x_2(0) - s^2 \brak{\dot{x_2}(0)-4}  +2}&=0
\end{align}

let $x_2(t)$ be constant at t=0
\begin{align}
\implies X_2(s)(s^4+2)&= 0
\end{align}
