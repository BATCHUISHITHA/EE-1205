...
Equating Transfer function from ~\eqref{eq:ishitha.g22.nm.54.3.eq} and ~\eqref{eq:ishitha.g22.nm.54.4.eq}
\begin{align}
\frac{m_2s^2+k_2}{k_2}&=\frac{k_2}{m_1s^2+k_1+k_2} \\
\frac{100s^2+200}{200}&=\frac{200}{200s^2+200+200}\\
\implies \brak{s^2+2}^2 &= 2 
\label{eq:ishitha.g22.nm.54.5.eq} 
\end{align}
  
 Substituting $s$ as $j\omega$ in ~\eqref{eq:ishitha.g22.nm.54.5.eq}
 \begin{align}
 \brak{2-\omega ^2}^2 &=2 \\
 \omega &= \pm\sqrt{2\mp\sqrt{2}} \\
 \implies \omega_{min} &= 0.766 rad/sec
 \end{align}
