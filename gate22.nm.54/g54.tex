...
\begin{align}
 k_1i_1 + L_1\frac{d^2i_1}{dt^2}+k_2\brak{i_1-i_2} &=0
\label{eq:ishitha.g22.nm.54.7.eq} \\
  L_2\frac{d^2i_2}{dt^2}-k_2\brak{i_1-i_2}  &=0
...
\begin{equation}
i^{''}(t) \systemL{} s^{2}I(s)-si(0)-i^{'}(0)
\end{equation}

Applying Laplace transform assuming current to be maximum;
\begin{align}
L_1\brak{s^2I_1(s) -i_1^{'}(0)} - k_2\brak{I_2(s)-I_1(s)} + k_1I_1(s) &= 0
\label{eq:ishitha.g22.nm.54.9.eq} \\
L_2\brak{s^2I_2(s)-i_2^{'}(0)} + k_2\brak{I_2(s)-I_1(s)}&=0
...
\begin{align}
\implies I_1(s)&=\frac{\brak{L_2s^2+k_2}L_1i_1^{'}(0) + k_2L_2i_2^{'}(0)}{L_1L_2s^4+(k_1+k_2)L_2s^2+k_2L_1s^2+k_1k_2} \\
\implies I_2(s)&= \frac{k_2L_1i_1^{'}(0)+\brak{L_1s^2 + \brak{k_1+k_2}}L_2i_2^{'}(0)}{L_1L_2s^4+(k_1+k_2)L_2s^2+k_2L_1s^2+k_1k_2} 
\end{align}

Considering denominator of $I_i(s)$ for $i=1,2$(ie: characteristic equation of the system):
\begin{align}
